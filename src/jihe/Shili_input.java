...
public class Shili_input {
	public static void main(String[] args) throws Exception{
		FileInputStream fin=new FileInputStream("E:\\Java\\数据表\\shili.xlsx");
		...
		FileInputStream fin_dext=new FileInputStream("E:\\Java\\数据表\\shili.xlsx");
		...
		FileOutputStream fout=new FileOutputStream("E:\\Java\\数据表\\shili.xlsx");
